...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<APIResponse<ProductResponseDTO>> createNewProduct(@RequestBody @Valid ProductRequestDTO productRequestDTO) {
    ...
    @GetMapping("/types")
    public ResponseEntity<APIResponse<Map<String, List<ProductResponseDTO>>>> getProductsGroupByType() {
